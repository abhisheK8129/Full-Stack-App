...
export const ShoppingOrderDetails = ({ orderDetails }) => {
  const { user } = useSelector((state) => state.authenticationSlice);
  return (
    <DialogContent className="sm:max-w-[600px] h-[600px] overflow-scroll">
      <div className="grid gap-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge
            className={`px-4 rounded-4xl py-2 font-bold ${
        ...
        <div className="grid gap-5">
          <div className="grid gap-3">
            ...
            <div className="grid  grid-cols-[repeat(auto-fit,minmax(500px,1fr))] gap-3 border-2 border-black rounded-lg p-2">
              ...
              <div className="font-bold">
                City:
                <span className="font-light"> {orderDetails?.addressInfo?.city}</span>
              </div>
              <div className="font-bold">
                Country :
                <span className="font-light">
